...
int.yn<-TRUE
# running this as though the two interventions were one continuous interv., then treat the separate periods as the two periods
int.start<-as.Date("2021-01-15")
...
tots.averted.upper.day<-round(tots.averted/int.duration,digits=1)
tots.averted.lower.day<-round(tots.averted/int.duration,digits=1)
...
tots.averted.upper.day.per1<-round(tots.averted.per1/int.duration.per1,digits=1)
tots.averted.lower.day.per1<-round(tots.averted.per1/int.duration.per1,digits=1)
...
tots.averted.upper.day.per2<-round(tots.averted.per2/int.duration.per2,digits=1)
tots.averted.lower.day.per2<-round(tots.averted.per2/int.duration.per2,digits=1)
...
percent.focal.averted.per1<-round(tots.averted/can.var.total.cases.per1*100,digits=1)
percent.focal.averted.lower.per1<-round(tots.averted.lower/can.var.total.cases.per1*100,digits=1)
percent.focal.averted.upper.per1<-round(tots.averted.upper/can.var.total.cases.per1*100,digits=1)
#3. period 2
...
percent.focal.averted.per2<-round(tots.averted/can.var.total.cases.per2*100,digits=1)
percent.focal.averted.lower.per2<-round(tots.averted.lower/can.var.total.cases.per2*100,digits=1)
percent.focal.averted.upper.per2<-round(tots.averted.upper/can.var.total.cases.per2*100,digits=1)
```
