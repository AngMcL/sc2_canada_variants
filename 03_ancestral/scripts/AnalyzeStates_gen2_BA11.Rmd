...
if(int.yn==T){
  ...
  int.descrip<-"Southern Africa entry ban, enhanced screening"
}
...
#updated these
variant.df.in.glob<-paste0("../01_subSample/Results_PreSubsamp_omi/variant.firstglobdate.csv")
variant.df.in<-paste0("../01_subSample/Results_PreSubsamp_omi/variant.df.can.csv")
...
# f.out<-"2023-07-05_ba11_analysis/"
...
cat(paste0("Proportion singletons of all intros = ",
           mean.95ci.X((sing.tot/tot.tot*100),0)),
    file=text.out,sep="\n",append=t)
...
## read in this data
meta.glob.var.country.daily.full3<-read.csv("../01_subSample/Results_PreSubsamp/meta.glob.var.country.daily.full3.csv")
...
```{r}
meta.can.var.country.daily.full3<-read.csv("../01_subSample/Results_PreSubsamp/meta.can.var.daily.full3.csv")
