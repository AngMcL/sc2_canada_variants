...
ft_trees_pre<-"../02_trees/202208_analysis/ft_kappamu_root_res"

focal.source<-c("South America") #colombia
focal.source.brf<-c("South America")
# lookup.geo$new.loc[lookup.geo$og.loc=="Colombia"]
...
#for figures
fig.start.date<-as.Date("2021-05-01")
...
if(focal.var=="mu"){
  varsubcol<-brewer.pal(n=7, "Purples")[c(3,4,5,6)]
}
